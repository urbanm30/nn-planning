...
heur_network = load_att_model_from_params("heuristic_networks/ma_maze_model_params/0-10-1-100")

max_time = 600

file_pls = string("planning_experiments_mac/att_tmps/tmp_att_",data_size,"_ma_maze_nn_",search_type,"_true_pls.jld")
file_exs = string("planning_experiments_mac/att_tmps/tmp_att_",data_size,"_ma_maze_nn_",search_type,"_true_exs.jld")
...
# pls = load(file_pls)["data"]
# exs = load(file_exs)["data"]
# filename = string("planning_experiments_mac/ma_maze_att_",data_size,"_",search_type,"_true_stats.csv") 
