...
for exp_folder in exp_folders_r
    ...
    # file_pls_gbfs = string("planning_experiments_mac/ma_tmps/tmp32_",splitted[1], "_", splitted[2],"_gbfs_true_pls.jld")
    # file_exs_gbfs = string("planning_experiments_mac/ma_tmps/tmp32_",splitted[1], "_", splitted[2],"_gbfs_true_exs.jld")

    file_pls_bfs = string("planning_experiments_mac/ma_tmps/tmp32_",splitted[1], "_", splitted[2],"_bfs_true_pls.jld")
    file_exs_bfs = string("planning_experiments_mac/ma_tmps/tmp32_",splitted[1], "_", splitted[2],"_bfs_true_exs.jld")
    ...
    # if start_no < 51 
        # open("planning_experiments_mac/ma_maze32_gbfs_true_stats.csv", "a") do f
        #     lens = transpose(gbfs_pls[exp_folder][2:end])
        #     exs = transpose(gbfs_exs[exp_folder][2:end])
        #     writedlm(f, lens)
        #     writedlm(f,exs)
        # end
        open("planning_experiments_mac/ma_maze32_bfs_true_stats.csv", "a") do f
...
for exp_folder in exp_folders_q
    ...
    # file_pls_gbfs = string("planning_experiments_mac/ma_tmps/tmp32_",splitted[1], "_", splitted[2],"_gbfs_true_pls_q.jld")
    # file_exs_gbfs = string("planning_experiments_mac/ma_tmps/tmp32_",splitted[1], "_", splitted[2],"_gbfs_true_exs_q.jld")

    file_pls_bfs = string("planning_experiments_mac/ma_tmps/tmp32_",splitted[1], "_", splitted[2],"_bfs_true_pls_q.jld")
    file_exs_bfs = string("planning_experiments_mac/ma_tmps/tmp32_",splitted[1], "_", splitted[2],"_bfs_true_exs_q.jld")
