...
file_pls = string("planning_experiments_mac/heur_tmps/tmp",data_size,"_mg_maze_",heur,"_",search_type,"_true_pls2.jld")
file_exs = string("planning_experiments_mac/heur_tmps/tmp",data_size,"_mg_maze_",heur,"_",search_type,"_true_exs2.jld")
...
#     pls = load(file_pls)["data"]
#     exs = load(file_exs)["data"]
#     filename = string("planning_experiments_mac/mg_maze",data_size,"_",search_type,"_heur_", heur, "_true_stats2.csv") 
