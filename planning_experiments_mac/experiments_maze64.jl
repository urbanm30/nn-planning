...
for exp_folder in exp_folders
    ...
    file_pls = string("planning_experiments_mac/tmps/tmp64_",splitted[1], "_", splitted[2],"_gbfs_pls.jld")
    file_exs = string("planning_experiments_mac/tmps/tmp64_",splitted[1], "_", splitted[2],"_gbfs_exs.jld")
...
# 
    ...
    if start_no < 51
        open("planning_experiments_mac/maze64_gbfs_true_stats.csv", "a") do f
...
for exp_folder in exp_folders
    ...
    file_pls = string("planning_experiments_mac/tmps/tmp64_",splitted[1], "_", splitted[2],"_bfs_pls.jld")
    file_exs = string("planning_experiments_mac/tmps/tmp64_",splitted[1], "_", splitted[2],"_bfs_exs.jld")
    ...
    if start_no < 51
        open("planning_experiments_mac/maze64_bfs_true_stats.csv", "a") do f
            lens = transpose(gbfs_pls[exp_folder][2:end])
            exs = transpose(gbfs_exs[exp_folder][2:end])
            writedlm(f, lens)
            writedlm(f,exs)
...
for exp_folder in exp_folders
    ...
    file_pls = string("planning_experiments_mac/tmps/tmp64_",splitted[1], "_", splitted[2],"_gbfs_pls_q.jld")
    file_exs = string("planning_experiments_mac/tmps/tmp64_",splitted[1], "_", splitted[2],"_gbfs_exs_q.jld")
...
for exp_folder in exp_folders
    ...
    file_pls = string("planning_experiments_mac/tmps/tmp64_",splitted[1], "_", splitted[2],"_bfs_pls_q.jld")
    file_exs = string("planning_experiments_mac/tmps/tmp64_",splitted[1], "_", splitted[2],"_bfs_exs_q.jld")
