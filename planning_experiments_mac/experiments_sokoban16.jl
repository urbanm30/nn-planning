...
for exp_folder in exp_folders_r
    ...
    file_pls_gbfs = string("planning_experiments_mac/sokoban_tmps/tmp16_",splitted[1], "_", splitted[2],"_gbfs_pls.jld")
    file_exs_gbfs = string("planning_experiments_mac/sokoban_tmps/tmp16_",splitted[1], "_", splitted[2],"_gbfs_exs.jld")

    file_pls_bfs = string("planning_experiments_mac/sokoban_tmps/tmp16_",splitted[1], "_", splitted[2],"_bfs_pls.jld")
    file_exs_bfs = string("planning_experiments_mac/sokoban_tmps/tmp16_",splitted[1], "_", splitted[2],"_bfs_exs.jld")
    ...
    for i in start_no:size(data,3)
        maze = data[:,:,i]      
        path, path_len, expanded_states = gbfs_timed(maze, false, "neural", [model, coords], max_time)        
        ...
        path, path_len, expanded_states = bfs_timed(maze, false, "neural", [model, coords], max_time)        
    ...
    # if start_no < 51
        open("planning_experiments_mac/sokoban16_gbfs_stats.csv", "a") do f
            lens = transpose(gbfs_pls[exp_folder][2:end])
            exs = transpose(gbfs_exs[exp_folder][2:end])
            writedlm(f, lens)
            writedlm(f,exs)
        end
        open("planning_experiments_mac/sokoban16_bfs_stats.csv", "a") do f
...
for exp_folder in exp_folders_q
    ...
    file_pls_gbfs = string("planning_experiments_mac/sokoban_tmps/tmp16_",splitted[1], "_", splitted[2],"_gbfs_pls_q.jld")
    file_exs_gbfs = string("planning_experiments_mac/sokoban_tmps/tmp16_",splitted[1], "_", splitted[2],"_gbfs_exs_q.jld")

    file_pls_bfs = string("planning_experiments_mac/sokoban_tmps/tmp16_",splitted[1], "_", splitted[2],"_bfs_pls_q.jld")
    file_exs_bfs = string("planning_experiments_mac/sokoban_tmps/tmp16_",splitted[1], "_", splitted[2],"_bfs_exs_q.jld")
